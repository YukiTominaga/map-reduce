 ...
 */
package dev.tominaga.beam.examples.complete.game;

import java.util.HashMap;
import java.util.Map;
import dev.tominaga.beam.examples.common.ExampleOptions;
import dev.tominaga.beam.examples.common.ExampleUtils;
import dev.tominaga.beam.examples.complete.game.utils.GameConstants;
import dev.tominaga.beam.examples.complete.game.utils.WriteToBigQuery;
import dev.tominaga.beam.examples.complete.game.utils.WriteWindowedToBigQuery;
